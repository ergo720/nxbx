...
void QtHost::SetStyleFromSettings()
{
	...
	{
		// Additional Theme option than loads .qss from main nxbx directory
		qApp->setStyle(QStyleFactory::create("Fusion"));

		QString sheet_content;
		QFile sheets(QString::fromStdString(combine_file_paths(emu_path::g_nxbx_dir, "custom.qss").string()));
