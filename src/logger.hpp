...
#define loggerex0(lv, msg, ...) do { logger<log_lv::lv, log_module::MODULE_NAME, false>(msg __VA_OPT__(,) __VA_ARGS__); } while(0)
#define loggerex1(lv, msg, ...) do { logger<log_lv::lv, log_module::MODULE_NAME, true>(msg __VA_OPT__(,) __VA_ARGS__); } while(0)
