...
class isettings {
public:
	virtual bool init(const std::string_view ini_path) = 0;
	virtual void save() = 0;
	...
	virtual bool get_bool_value(const char *a_pSection, const char *a_pKey, bool a_nDefault) = 0;
	...
	virtual void set_bool_value(const char *a_pSection, const char *a_pKey, bool a_pValue) = 0;
