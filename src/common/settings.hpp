...
public:
	...
	bool get_bool_value(const char *a_pSection, const char *a_pKey, bool a_nDefault) override;
	...
	void set_bool_value(const char *a_pSection, const char *a_pKey, bool a_pValue) override;
