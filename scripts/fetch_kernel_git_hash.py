...
git_hash = subprocess.check_output(["git", "ls-remote", "https://github.com/ergo720/nboxkrnl", "HEAD"]).strip().decode('utf-8')[:40]
with open("../build/kernel_version.hpp", "w+") as kernel_version_temp_f:
    ...
    try:
        with open("../src/nxbx/kernel_version.hpp", "r+") as kernel_version_f:
        ...
        with open("../src/nxbx/kernel_version.hpp", "w") as kernel_version_f:
            kernel_version_f.write(kernel_header_temp_str)
